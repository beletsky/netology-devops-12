...
1. Для создания собственных образов используется инструмент [Packer](https://www.packer.io/).

2. Исходная конфигурация терраформа расположена в папке [terraform](terraform/).
...
Terraform will perform the following actions:
  ...
  + resource "yandex_compute_instance" "vm" {
      ...
      + description               = "Homework 07-02"
      + folder_id                 = "b1gjc6s8ee54eedsvb9o"
      + fqdn                      = (known after apply)
      + hostname                  = "netology-07-02"
