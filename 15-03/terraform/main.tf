...
#
#resource "yandex_resourcemanager_cloud_iam_binding" "allusers_kms" {
#  cloud_id  = var.yc_cloud
#  role      = "kms.keys.encrypterDecrypter"
#  members   = [
#    "system:allUsers"
...
resource "yandex_storage_object" "lake" {
  ...
  depends_on = [
    ...
    yandex_resourcemanager_folder_iam_member.images-storage-editor,
    yandex_resourcemanager_folder_iam_member.images-kms,
  ]
}
